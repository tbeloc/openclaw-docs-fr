...
| Runner                          | Jobs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ubuntu-24.04`                  | `security-fast`, manual CI dispatch and non-canonical repository fallbacks, pull-request retries of both UI E2E jobs, QA Smoke, CodeQL security and quality scans, workflow-sanity, labeler, auto-response, the standalone Docs workflow, the whole Install Smoke workflow, and all configurable CI jobs while the GitHub-hosted outage backend is active. In that degraded mode, QA Smoke expands to six parts, core oxlint splits across three hosted stripes, and the existing `check-lint` row owns extension/scripts lint plus optional UI and format checks. |
...
| `blacksmith-16vcpu-ubuntu-2404` | Automatic QA Smoke CI shards, first-attempt same-repo pull requests and pushes for `checks-ui-e2e-real-gateway`, and `build-artifacts` in CI and Testbox                                                                                                                                                                                                                                                                                                                                                                                                           |
| `blacksmith-32vcpu-ubuntu-2404` | `check-lint` and `check-dependencies`; both are CPU-sensitive enough that smaller runners extend the critical path                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
