---
summary: "Dépannage de l'appairage des nœuds, des exigences de premier plan, des permissions et des défaillances d'outils"
read_when:
...
- `CAMERA_DISABLED` → le basculement de caméra est désactivé dans les paramètres du nœud.
