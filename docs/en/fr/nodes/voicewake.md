...
- La modification des mots de réveil dans les paramètres appelle `voicewake.set` (via la WS de la Passerelle) et maintient également la détection locale des mots de réveil réactive.
