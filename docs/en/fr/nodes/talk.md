---
summary: "Mode Talk : conversations en parole continue avec TTS ElevenLabs"
read_when:
...
- Les réponses sont **écrites dans WebChat** (comme la saisie).
...
- Basculement de la barre de menu : **Talk**
- Onglet Config : groupe **Talk Mode** (ID de voix + basculement d'interruption)
- Superposition :
