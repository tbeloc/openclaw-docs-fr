...
Les permissions du système d'exploitation sont multi-niveaux. Nous pouvons exposer un sélecteur dans l'application, mais le système d'exploitation décide toujours de l'octroi réel.
...
- La localisation précise est un octroi séparé (iOS 14+ « Précis », Android « fine » vs « coarse »).

Le sélecteur dans l'interface utilisateur détermine notre mode demandé ; l'octroi réel se trouve dans les paramètres du système d'exploitation.
