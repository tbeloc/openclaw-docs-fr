...
Si les ressources de l'interface de contrôle sont manquantes, l'assistant tente de les construire ; le recours est `pnpm ui:build` (installe automatiquement les dépendances de l'interface).
</Note>
