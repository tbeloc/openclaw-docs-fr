...
- Dans le périmètre : credentials strictement fournis par l'utilisateur qu'OpenClaw ne génère ni ne fait tourner.
...
- Ces credentials sont des classes générées, en rotation, porteuses de session, ou durables OAuth qui ne correspondent pas à la résolution SecretRef externe en lecture seule.
