...
- `pnpm test:live`: Exécute les tests en direct du fournisseur (minimax/zai). Nécessite des clés API et `LIVE=1` (ou `*_LIVE_TEST=1` spécifique au fournisseur) pour ignorer.
