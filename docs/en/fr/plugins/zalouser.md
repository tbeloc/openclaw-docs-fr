...
L'identifiant du canal est `zalouser` pour clarifier qu'il automatise un **compte utilisateur Zalo personnel** (non officiel). Nous réservons `zalo` pour une intégration potentielle future avec l'API Zalo officielle.
