...
`agents.list[].tools`. La politique de liste blanche/liste noire contrôle les outils que l'agent
peut appeler.
...
- Préférez `optional: true` pour les outils qui déclenchent des effets secondaires ou nécessitent des binaires/identifiants supplémentaires.
