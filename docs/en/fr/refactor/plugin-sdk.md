...
- Assurer que la sémantique de réponse/saisie correspond au comportement actuel.
...
- Ajouter des vérifications de compatibilité SDK/version des plugins (runtime + semver du SDK).
...
- Distribution du type runtime : dans le SDK (types uniquement) ou dans le noyau ?
...
Docs connexes : [Plugins](/fr/tools/plugin), [Channels](/fr/channels/index), [Configuration](/fr/gateway/configuration).
