...
OpenProse enregistre `/prose` comme commande de compétence invocable par l'utilisateur. Elle route vers les instructions de la VM OpenProse et utilise les outils OpenClaw en arrière-plan.
