...
Documentation associée : [Plugins](/fr/tools/plugin), [Manifeste de plugin](/fr/plugins/manifest), [Compétences](/fr/tools/skills).
...
Si votre liste d'autorisation d'outils bloque ces outils, les programmes OpenProse échoueront. Voir [Configuration des compétences](/fr/tools/skills-config).
...
Pour les workflows déterministes et contrôlés par approbation, comparez avec [Lobster](/fr/tools/lobster).
