...
- [Assistant d'intégration (CLI)](/fr/start/wizard)
...
- [Intégration (Application macOS)](/fr/start/onboarding)

## Fournisseur personnalisé

Si vous avez besoin d'un point de terminaison qui n'est pas répertorié, y compris les fournisseurs hébergés qui exposent des API OpenAI ou Anthropic standard, choisissez **Fournisseur personnalisé** dans l'assistant CLI. On vous demandera de :
