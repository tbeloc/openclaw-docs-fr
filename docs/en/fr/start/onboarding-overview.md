...
OpenClaw prend en charge plusieurs chemins d'intégration selon l'endroit où la passerelle s'exécute
et la façon dont vous préférez configurer les fournisseurs.
...
Utilisez l'assistant CLI lorsque vous souhaitez un contrôle total de la passerelle, de l'espace de travail,
...
exposent des API OpenAI ou Anthropic standard, choisissez **Fournisseur personnalisé** dans l'
assistant CLI. Vous serez invité à :
...
Pour les étapes détaillées, suivez la documentation d'intégration CLI ci-dessus.
