---
summary: "Configuration automatisée et mise en place d'agent pour OpenClaw CLI"
read_when:
...
- Référence complète : [Référence CLI d'intégration](/fr/start/wizard-cli-reference)
