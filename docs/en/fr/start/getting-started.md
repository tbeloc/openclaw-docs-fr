...
<Tooltip headline="Hôte de passerelle" tip="La machine exécutant le service de passerelle OpenClaw.">hôte de passerelle</Tooltip>.
...
/>
  ...
  <Step title="Exécuter l'assistant d'intégration">
    ...
    L'assistant configure l'authentification, les paramètres de passerelle et les canaux optionnels.
...
- Sécurité et approbations des messages directs : [Appairage](/channels/pairing)
- Connecter plus de canaux : [Canaux](/channels)
- Flux de travail avancés et installation à partir de la source : [Configuration](/start/setup)
