...
Utilisez ACP lorsqu'un IDE (ou un autre client) parle Agent Client Protocol et que vous voulez qu'il pilote une session de passerelle OpenClaw.
...
En savoir plus sur les clés de session à [/concepts/session](/fr/concepts/session).
