...
- Les écritures de marqueurs sont source-autoritaires : OpenClaw persiste les marqueurs à partir de l'instantané de configuration source active, et non à partir des valeurs de secrets résolus au moment de l'exécution.
