...
- Les invites interactives (comme les corrections de trousseau/OAuth) ne s'exécutent que lorsque stdin est un TTY et que `--non-interactive` n'est **pas** défini. Les exécutions sans terminal (cron, Telegram, pas de terminal) ignoreront les invites.
