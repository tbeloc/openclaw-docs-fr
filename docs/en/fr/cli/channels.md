...
Gérez les comptes de canaux de chat et leur statut d'exécution sur la passerelle.

Documentation connexe :

- Guides des canaux : [Channels](/fr/channels/index)
- Configuration de la passerelle : [Configuration](/fr/gateway/configuration)
