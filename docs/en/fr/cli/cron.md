...
- Tâches cron : [Cron jobs](/fr/automation/cron-jobs)
...
Remarque : les tâches récurrentes utilisent désormais une stratégie de retry avec backoff exponentiel après des erreurs consécutives (30s → 1m → 5m → 15m → 60m), puis reviennent au calendrier normal après la prochaine exécution réussie.
