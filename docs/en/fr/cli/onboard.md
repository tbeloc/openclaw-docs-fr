...
- Hub d'intégration CLI : [Onboarding Wizard (CLI)](/fr/start/wizard)
- Aperçu de l'intégration : [Onboarding Overview](/fr/start/onboarding-overview)
- Référence d'intégration CLI : [CLI Onboarding Reference](/fr/start/wizard-cli-reference)
- Automatisation CLI : [CLI Automation](/fr/start/wizard-cli-automation)
- Intégration macOS : [Onboarding (macOS App)](/fr/start/onboarding)
...
- Sauf si vous passez `--skip-health`, l'intégration attend une gateway locale accessible avant de quitter avec succès.
...
- L'intégration effectue une validation de préflight rapide avant de sauvegarder la référence.
...
- Comportement de portée DM d'intégration locale : [CLI Onboarding Reference](/fr/start/wizard-cli-reference#outputs-and-internals).
