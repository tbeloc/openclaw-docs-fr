...
Flux interactif pour choisir un canal de mise à jour et confirmer s'il faut redémarrer la Gateway après la mise à jour (par défaut, redémarrer). Si vous sélectionnez `dev` sans une extraction git, il propose d'en créer une.
