...
Recherches d'annuaire pour les canaux qui les supportent (contacts/pairs, groupes et "moi").
...
- Pour de nombreux canaux, les résultats sont soutenus par la configuration (listes blanches / groupes configurés) plutôt que par un annuaire de fournisseur en direct.
