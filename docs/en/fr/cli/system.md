...
Utilitaires au niveau système pour la Gateway : mettre en file d'attente des événements système, contrôler les heartbeats,
...
Mettre en file d'attente un événement système sur la session **main**. Le prochain heartbeat l'injectera
comme une ligne `System:` dans le prompt. Utilisez `--mode now` pour déclencher le heartbeat
