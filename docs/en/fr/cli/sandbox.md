...
Listez tous les conteneurs sandbox avec leur statut et configuration.
...
- Les conteneurs ne sont purgés qu'après 24h d'inactivité
...
- [Configuration Agent](/fr/concepts/agent-workspace)
- [Commande Doctor](/fr/gateway/doctor) - Vérifier la configuration sandbox
