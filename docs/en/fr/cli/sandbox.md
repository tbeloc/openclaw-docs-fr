...
Inspectez le mode/portée/accès à l'espace de travail sandbox **effectif**, la politique d'outils sandbox et les portes élevées (avec les chemins de clés de configuration de correction).
...
- Les conteneurs ne sont supprimés que après 24h d'inactivité
- Les agents régulièrement utilisés conservent les anciens conteneurs indéfiniment
  ...
  "agents": {
    "defaults": {
      "sandbox": {
        ...
        "prune": {
          "idleHours": 24, // Suppression automatique après 24h d'inactivité
