...
- L'aperçu inclut le canal de mise à jour + git SHA (pour les checkouts source).
- Les informations de mise à jour s'affichent dans l'aperçu ; si une mise à jour est disponible, status affiche un conseil pour exécuter `openclaw update` (voir [Updating](/fr/install/updating)).
