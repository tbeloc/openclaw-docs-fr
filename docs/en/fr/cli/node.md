...
L'exécution est toujours protégée par les **approbations d'exécution** et les listes d'autorisation par agent sur le
nœud hôte, vous pouvez donc garder l'accès aux commandes limité et explicite.
