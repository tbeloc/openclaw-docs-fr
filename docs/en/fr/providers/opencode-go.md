...
OpenCode Go est le catalogue Go dans [OpenCode](/providers/opencode).
...
- Utilisez [OpenCode](/providers/opencode) pour l'intégration partagée et l'aperçu du catalogue.
