...
Qianfan est la plateforme MaaS de Baidu, qui fournit une **API unifiée** qui achemine les demandes vers de nombreux modèles derrière un seul point de terminaison et une seule clé API. Elle est compatible avec OpenAI, donc la plupart des SDK OpenAI fonctionnent en changeant l'URL de base.

## Prérequis

1. Un compte Baidu Cloud avec accès à l'API Qianfan
2. Une clé API de la console Qianfan
...
- [Configuration d'agent](/fr/concepts/agent)
