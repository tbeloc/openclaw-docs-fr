...
Consultez le [README du plugin MiniMax OAuth](https://github.com/openclaw/openclaw/tree/main/extensions/minimax-portal-auth) pour plus de détails.
...
**Idéal pour :** garder votre modèle le plus puissant de dernière génération comme principal, basculer vers MiniMax M2.5.
...
et aucune clé d'environnement/profil d'authentification MiniMax trouvée). Un correctif pour cette détection est dans
