...
GitHub Copilot est l'assistant de codage IA de GitHub. Il fournit l'accès aux modèles Copilot pour votre compte et plan GitHub. OpenClaw peut utiliser Copilot comme fournisseur de modèle de deux façons différentes.
