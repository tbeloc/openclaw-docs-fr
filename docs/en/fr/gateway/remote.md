...
- **Exemples :** [exe.dev](/fr/install/exe-dev) (VM facile) ou [Hetzner](/fr/install/hetzner) (VPS production).
...
- **Les nœuds n'exécutent pas le service gateway.** Une seule gateway devrait s'exécuter par hôte sauf si vous exécutez intentionnellement des profils isolés (voir [Plusieurs gateways](/fr/gateway/multiple-gateways)).
