...
2. Sinon, si Bonjour trouve une passerelle sur LAN, proposez un choix « Utiliser cette passerelle » en un clic et enregistrez-le comme point de terminaison direct.
...
- **Nœuds iOS/Android** : parcourez Bonjour par commodité et connectez-vous à la Passerelle WS appairée.
