...
Note sur l'héritage : supprimez tout Agent de Lancement `com.openclaw.ssh-tunnel` restant s'il est présent.
...
OpenClaw.app se connecte à `ws://127.0.0.1:18789` sur votre machine client. Le tunnel SSH transfère cette connexion au port 18789 sur la machine distante où la Passerelle s'exécute.
