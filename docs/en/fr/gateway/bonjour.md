...
OpenClaw utilise Bonjour (mDNS / DNS‑SD) comme **commodité LAN uniquement** pour découvrir
une Gateway active (point de terminaison WebSocket). C'est un effort optimal et ne
**remplace pas** la connectivité SSH ou basée sur Tailnet.
