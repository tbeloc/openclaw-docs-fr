...
- Il n'y a pas de limite de propriétaire non-séparé/par utilisateur sur ce point de terminaison ; une fois qu'un appelant passe l'authentification Gateway ici, OpenClaw traite cet appelant comme un opérateur de confiance pour cette gateway.
