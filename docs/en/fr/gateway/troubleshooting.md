...
- Octrois de permissions du système d'exploitation pour la caméra/micro/localisation/écran.
...
Utilisez ceci quand les actions de l'outil navigateur échouent même si la passerelle elle-même est saine.
...
- Attachement de l'onglet de relais d'extension pour `profile="chrome-relay"`.
...
La plupart des dysfonctionnements post-mise à jour sont dus à une dérive de configuration ou à des paramètres par défaut plus stricts qui sont maintenant appliqués.
