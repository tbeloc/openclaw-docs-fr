---
summary: "Appairage détenu par la passerelle (Option B) pour les nœuds iOS et autres nœuds distants"
read_when:
...
- **Transport** : le point de terminaison WS de la Passerelle transfère les demandes mais ne décide pas de l'adhésion.
  (Le support du pont TCP hérité est obsolète/supprimé.)
...
4. Lors de l'approbation, la Passerelle émet un **nouveau jeton** (les jetons sont renouvelés lors du réappairage).
...
## Flux CLI (convivial sans interface)
