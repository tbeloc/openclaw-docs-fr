...
OpenClaw peut exécuter des **CLIs d'IA locaux** comme **secours texte uniquement** quand les fournisseurs d'API sont indisponibles,
...
voulez des réponses texte « qui fonctionnent toujours » sans dépendre d'APIs externes.
...
chemins de fichiers à l'invite (injection de chemin), ce qui est suffisant pour les CLIs qui chargent automatiquement
...
- **Pas d'outils OpenClaw** (le backend CLI ne reçoit jamais d'appels d'outils). Certains CLIs
