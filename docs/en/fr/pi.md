...
├── pi-embedded-block-chunker.ts   # Chunking de réponse de bloc en streaming
...
Pour les commandes d'exécution actuelles, voir [Flux de travail de développement Pi](/pi-dev).
