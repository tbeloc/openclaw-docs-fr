...
- [Accès distant à la passerelle](/fr/gateway/remote) — autres modèles d'accès distant
...
- [Guide DigitalOcean](/fr/platforms/digitalocean) — si vous préférez payant + inscription plus facile
