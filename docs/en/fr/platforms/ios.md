...
## Push soutenu par relais pour les builds officiels
...
- Aucune clé APNs directe pour les envois de relais soutenu officiel/TestFlight.
...
- Une gateway ne peut envoyer des pushes soutenus par relais que pour les appareils iOS qui se sont appairés avec cette gateway spécifique.
...
- Pour éviter de stocker les tokens APNs bruts de build officiel sur la gateway.
