```markdown
---
summary: "Application iOS node : connexion à la Gateway, appairage, canvas et dépannage"
read_when:
...
5. `Relais -> APNs`
   ...
   - La gateway ne stocke jamais le jeton APNs brut pour les builds officiels soutenus par relais.
