---
summary: "Journalisation OpenClaw : journal de fichier de diagnostics roulant + drapeaux d'intimité de journal unifié"
read_when:
...
- Activer : **Volet Débogage → Journaux → Journalisation d'application → « Écrire un journal de diagnostics roulant (JSONL) »**
