...
- `ai.openclaw.gateway` (ou `ai.openclaw.<profile>` ; les anciennes `com.openclaw.*` peuvent subsister)
...
- La fermeture de l'application n'arrête **pas** la passerelle (launchd la maintient active).
