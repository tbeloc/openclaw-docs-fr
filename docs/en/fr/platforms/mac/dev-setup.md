...
Pour les modes d'exécution de développement, les drapeaux de signature et la résolution des problèmes d'ID d'équipe, consultez le fichier README de l'application macOS :
...
Si l'état de la passerelle reste sur « Démarrage... », vérifiez si un processus zombie occupe le port :
