...
OpenClaw installe un service systemd **utilisateur** par défaut. Utilisez un service **système** pour les serveurs partagés ou toujours actifs. L'exemple d'unité complet et les conseils se trouvent dans le [runbook Gateway](/gateway).
