...
Si vous voulez une option à 0 $/mois et que vous ne craignez pas ARM + configuration spécifique au fournisseur, consultez le [guide Oracle Cloud](/platforms/oracle).
...
| Linode       | Nanode          | 1 vCPU, 1GB RAM        | $5          | Désormais partie d'Akamai                  |
...
- Oracle Cloud : peut être gratuit, mais plus capricieux et ARM uniquement (voir [guide Oracle](/platforms/oracle))
...
<Warning>
Utilisez une image de base propre (Ubuntu 24.04 LTS). Évitez les images Marketplace tiers en un clic à moins d'avoir examiné leurs scripts de démarrage et paramètres de pare-feu.
</Warning>
...
Voir [Channels](/channels) pour les autres fournisseurs.
...
Oracle Cloud offre des instances ARM **Always Free** considérablement plus puissantes que n'importe quelle option payante ici — pour 0 $/mois.
...
Pour le guide de configuration complet, voir [Oracle Cloud](/platforms/oracle). Pour les conseils d'inscription et le dépannage du processus d'inscription, voir ce [guide communautaire](https://gist.github.com/rssnyder/51e3cfedd730e7dd5f4a816143b25dbd).
