...
- Installation : [Démarrage](/fr/start/getting-started) + [Appairage](/fr/channels/pairing).
- Passerelle : [Runbook](/fr/gateway) + [Configuration](/fr/gateway/configuration).
  - Protocoles : [Protocole de passerelle](/fr/gateway/protocol) (nœuds + plan de contrôle).
...
Détails d'appairage : [Appairage](/fr/channels/pairing).
...
Voir [Nœud caméra](/fr/nodes/camera) pour les paramètres et les assistants CLI.
