...
- Vous pouvez exécuter l'interface de ligne de commande (`openclaw`) sur la machine de passerelle (ou via SSH).
...
- Redémarrez la passerelle / l'application de barre de menus macOS.
...
- Utilisez le mode **Code d'installation** ou **Manuel**.
