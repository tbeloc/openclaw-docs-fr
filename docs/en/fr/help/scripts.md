---
summary: "Scripts du référentiel : objectif, portée et notes de sécurité"
read_when:
  - Exécution de scripts depuis le référentiel
...
Le répertoire `scripts/` contient des scripts d'aide pour les flux de travail locaux et les tâches opérationnelles.
