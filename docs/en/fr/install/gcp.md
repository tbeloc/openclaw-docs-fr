...
| e2-micro  | 2 vCPU (partagé), 1GB RAM | Éligible couche gratuite | Échoue souvent avec OOM de build Docker (exit 137)      |
...
1. Allez à Compute Engine > Instances VM > Créer une instance
