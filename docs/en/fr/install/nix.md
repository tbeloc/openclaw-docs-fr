...
(ID de bundle, version/build, SHA Git, clés Sparkle). Cela garde le plist déterministe pour l'empaquetage SwiftPM
...
- [Wizard](/start/wizard) — configuration CLI sans Nix
