...
- **Podman sans privilèges échoue pour l'utilisateur openclaw :** Vérifiez que `/etc/subuid` et `/etc/subgid` contiennent une ligne pour `openclaw` (par exemple `openclaw:100000:65536`). Ajoutez-la si elle est manquante et redémarrez.
