...
Modifiez `openclaw.json` dans `scripts/k8s/manifests/configmap.yaml`. Voir [Configuration de la passerelle](/fr/gateway/configuration) pour la référence complète.
