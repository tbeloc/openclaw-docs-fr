...
Utilisez le nom d'image `ghcr.io/openclaw/openclaw` (pas les images Docker Hub de nom similaire).
...
Si vous choisissez de s'exécuter en tant que root pour la commodité, vous acceptez le compromis de sécurité.
