...
read_when:
  ...
  - Le service de passerelle s'exécute toujours après la désinstallation
...
- **Suppression manuelle du service** si le CLI a disparu mais le service s'exécute toujours.
