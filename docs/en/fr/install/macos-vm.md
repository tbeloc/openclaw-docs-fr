...
Ensuite, connectez-vous à WhatsApp (scannez le code QR) :
...
| Code QR WhatsApp ne scanne pas | Assurez-vous que vous êtes connecté à la VM (pas l'hôte) lors de l'exécution de `openclaw channels login` |
