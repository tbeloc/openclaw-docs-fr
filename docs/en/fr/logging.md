...
OpenClaw enregistre les journaux dans deux emplacements :
...
Les drapeaux ne sont pas sensibles à la casse et prennent en charge les caractères génériques (par exemple `telegram.*` ou `*`).
