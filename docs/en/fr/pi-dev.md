...
Ce guide résume un flux de travail sensé pour travailler sur l'intégration pi dans OpenClaw.

## Vérification des types et linting

- Vérifier les types et construire : `pnpm build`
- Linter : `pnpm lint`
- Vérifier le formatage : `pnpm format`
- Portail complet avant de pousser : `pnpm lint && pnpm build && pnpm test`
