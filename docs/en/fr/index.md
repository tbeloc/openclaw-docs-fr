```markdown
---
summary: "OpenClaw est une passerelle multi-canaux pour les agents IA qui fonctionne sur n'importe quel système d'exploitation."
read_when:
...
<p align="center">
  <strong>Passerelle multi-systèmes d'exploitation pour les agents IA sur WhatsApp, Telegram, Discord, iMessage, et bien d'autres.</strong><br />
  Envoyez un message, obtenez une réponse d'agent depuis votre poche. Les plugins ajoutent Mattermost et bien d'autres.
</p>
...
OpenClaw est une **passerelle auto-hébergée** qui connecte vos applications de chat préférées — WhatsApp, Telegram, Discord, iMessage, et bien d'autres — à des agents IA de codage comme Pi. Vous exécutez un seul processus de passerelle sur votre propre machine (ou un serveur), et il devient le pont entre vos applications de messagerie et un assistant IA toujours disponible.

**Pour qui est-ce ?** Les développeurs et utilisateurs avancés qui veulent un assistant IA personnel auquel ils peuvent envoyer des messages de n'importe où — sans abandonner le contrôle de leurs données ni dépendre d'un service hébergé.

**Qu'est-ce qui le rend différent ?**

- **Auto-hébergé** : s'exécute sur votre matériel, vos règles
- **Multi-canaux** : une seule passerelle sert WhatsApp, Telegram, Discord, et bien d'autres simultanément
...
<Columns>
  ...
  <Card title="Nœuds mobiles" icon="smartphone">
    Appairez les nœuds iOS et Android pour les flux de travail Canvas, caméra et activés par la voix.
  </Card>
</Columns>
