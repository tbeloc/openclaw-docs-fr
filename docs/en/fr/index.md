...
<Columns>
  ...
  <Card title="Exécuter l'assistant" href="/fr/start/wizard" icon="sparkles">
...
- **Multi-canaux** : une passerelle unique sert WhatsApp, Telegram, Discord, et plus simultanément
...
Besoin de la configuration complète d'installation et de développement ? Voir [Démarrage rapide](/fr/start/quickstart).
