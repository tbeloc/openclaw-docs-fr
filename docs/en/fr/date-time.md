---
summary: "Gestion de la date et de l'heure dans les enveloppes, invites, outils et connecteurs"
read_when:
...
Les horodatages des fournisseurs sont conservés pour que les outils conservent leur sémantique native (l'heure actuelle est disponible via `session_status`).
...
### Configurer le fuseau horaire de l'utilisateur + format
...
Les champs bruts du fournisseur sont conservés pour qu'aucune information ne soit perdue.
