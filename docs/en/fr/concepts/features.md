...
<Columns>
  ...
  <Card title="Applications et UI" icon="monitor">
...
- Sessions : les chats directs se regroupent dans un `main` partagé ; les groupes sont isolés
...
- Hook de transcription de notes vocales optionnel
