...
les fichiers d'amorçage injectés (par exemple, remplacer `SOUL.md` par une persona alternative).
...
Cela garde l'invite de base petite tout en permettant une utilisation ciblée des compétences.
