...
Si vous voulez le contexte de protocole de haut niveau, commencez par
...
- Le `GatewayFrame` de haut niveau utilise un **discriminateur** sur `type`.
...
3. Validez les schémas régénérés + modèles Swift.
