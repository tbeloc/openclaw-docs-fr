...
Les types de trame inconnus sont préservés comme charges utiles brutes pour la compatibilité future.
...
- Les modèles Swift conservent les types de trame inconnus pour éviter de casser les anciens clients.
