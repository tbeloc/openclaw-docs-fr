...
- [Protocole de la passerelle](/fr/gateway/protocol)
...
Détails : [Protocole de la passerelle](/fr/gateway/protocol), [Appairage](/fr/channels/pairing),
...
- La négociation est obligatoire ; toute première trame non-JSON ou non-connect est une fermeture dure.
