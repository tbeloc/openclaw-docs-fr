...
Nous sérialisons les exécutions de réponse automatique entrantes (tous les canaux) via une minuscule file d'attente en processus pour éviter que plusieurs exécutions d'agent ne se heurtent, tout en permettant un parallélisme sûr entre les sessions.
