...
3. **Basculement d'authentification du fournisseur** se produit à l'intérieur d'un fournisseur avant de passer au
   modèle suivant.
...
Comportement/configuration complète de la commande : [Slash commands](/tools/slash-commands).
