...
- `gateway.auth.mode: "trusted-proxy"` : authentification par proxy inverse pour les clients de navigateur (voir [Authentification par proxy de confiance](/fr/gateway/trusted-proxy-auth)).
