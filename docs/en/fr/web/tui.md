...
- Si votre terminal utilise un arrière-plan clair et la détection automatique est incorrecte, définissez `OPENCLAW_THEME=light` avant de lancer `openclaw tui`.
