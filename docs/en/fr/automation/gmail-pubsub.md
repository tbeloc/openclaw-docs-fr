...
- `model`/`thinking` par hook dans le mappage remplacent toujours ces valeurs par défaut.
...
Si vous avez besoin d'un tunnel non-Tailscale, câblez-le manuellement et utilisez l'URL publique dans la souscription push
