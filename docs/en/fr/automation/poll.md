...
- Discord : 2-10 options, `durationHours` limité à 1-768 heures (24 par défaut). `maxSelections > 1` active la multi-sélection ; Discord ne supporte pas un nombre de sélections strict.
