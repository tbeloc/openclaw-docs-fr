...
Vous avez repéré un vecteur d'attaque ou un risque que nous n'avons pas couverts ? Ouvrez un problème sur [openclaw/trust](https://github.com/openclaw/trust/issues) et décrivez-le avec vos propres mots. Vous n'avez pas besoin de connaître des cadres ou de remplir tous les champs - décrivez simplement le scénario.
...
Les contributeurs au modèle de menace sont reconnus dans les remerciements du modèle de menace, les notes de version et le hall of fame de la sécurité OpenClaw pour les contributions importantes.
