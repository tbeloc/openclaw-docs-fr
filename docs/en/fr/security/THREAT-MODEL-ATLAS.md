...
| **Atténuations actuelles** | Vérification de l'âge du compte GitHub, drapeaux de modération basés sur motif |
...
| ----------------------- | ---------------------------------------------------------------------- |
| **ID ATLAS**            | AML.T0043 - Créer des données adversariales                             |
| **Description**         | L'attaquant crée du contenu de compétence pour contourner les motifs de modération |
| **Vecteur d'attaque**   | Homoglyphes Unicode, astuces d'encodage, chargement dynamique           |
| **Composants affectés** | Modération ClawHub.ts                                                   |
| **Atténuations actuelles** | FLAG_RULES basées sur motif                                            |
...
| ----------------------- | --------------------------------------------------------- |
| **ID ATLAS**            | AML.T0043 - Créer des données adversariales                |
| **Description**         | L'attaquant crée du contenu qui s'échappe du contexte d'encapsulation XML |
...
| **Vecteur d'attaque**   | Injection de prompt causant l'envoi de message par l'agent à l'attaquant |
...
| **Risque résiduel**     | Critique - Exécution d'hôte sans bac à sable         |
| **Recommandations**     | Bac à sable par défaut, améliorer l'UX d'approbation |
