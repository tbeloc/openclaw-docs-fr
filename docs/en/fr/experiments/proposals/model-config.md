...
- Sélection simple `/model` avec des basculements prévisibles.
...
- Utiliser une liste de basculement global pour que toutes les sessions basculent de manière cohérente.
