...
# Workspace Memory v2 (offline): notes de recherche
...
- propose optionnellement des édits à `memory.md` (« faits durables noyau-ish »)
...
Si « S-Collide » fait référence à **SuCo (Subspace Collision)** : c'est une approche de récupération ANN qui cible des compromis forts rappel/latence en utilisant des collisions apprises/structurées dans les sous-espaces (article : arXiv 2411.14754, 2024).
