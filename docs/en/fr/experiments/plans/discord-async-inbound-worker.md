...
3. Réduire les tâches en file d'attente à des données pures spécifiques à Discord :
   ...
   - décisions de gating et de liaison
...
C'est toujours un suivi borné s'il est gardé Discord uniquement et si nous continuons à éviter une abstraction de worker entre canaux prématurée.
