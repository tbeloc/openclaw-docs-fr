---
summary: "État et prochaines étapes pour découpler les écouteurs de passerelle Discord des tours d'agent longue durée avec un worker entrant spécifique à Discord"
owner: "openclaw"
status: "in_progress"
...
- L'observabilité du worker et l'état de l'opérateur sont toujours minimaux
...
- mettre à jour l'état et les diagnostics
...
- État : non commencé
- émettre la profondeur de la file d'attente et les compteurs de workers actifs dans l'état du moniteur
...
Cela devrait être un suivi séparé sauf si la récupération de redémarrage est requise pour l'atterrissage.
