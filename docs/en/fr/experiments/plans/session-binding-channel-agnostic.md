...
- si l'achèvement en mode session se résout en une destination liée active, la livraison doit cibler cette destination
...
- la rotation du jeton du gestionnaire utilise le dernier jeton après la réutilisation du gestionnaire
