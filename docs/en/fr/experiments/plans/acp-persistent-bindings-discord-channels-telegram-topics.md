...
- Les entrées persistantes déclarent l'état souhaité ; le runtime réconcilie aux sessions/liaisons ACP réelles.
...
- `SessionBindingService` supporte déjà les références de conversation agnostiques au canal.
...
- Ajouter des docs avec des exemples pour :
  ...
  - « plusieurs canaux/sujets par même agent avec `cwd` différent »
