...
- Rejeter les événements de runtime mal formés dès le départ et fournir des diagnostics structurés.
...
- Ajouter des ID de livraison par tour/par chunk.
...
- Phase 1 : mode fantôme (le nouveau pipeline calcule la sortie mais l'ancien chemin envoie ; comparer).
...
- Risque : régressions comportementales dans les chemins main/subagent existants.
  Atténuation : diffing en mode fantôme + tests de contrat d'adaptateur + tests e2e de canal.
