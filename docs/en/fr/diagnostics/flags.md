...
- Les drapeaux sont sûrs à laisser activés ; ils n'affectent que le volume de journalisation du sous-système spécifique.
- Utilisez [/logging](/fr/logging) pour modifier les destinations des journaux, les niveaux et la rédaction.
