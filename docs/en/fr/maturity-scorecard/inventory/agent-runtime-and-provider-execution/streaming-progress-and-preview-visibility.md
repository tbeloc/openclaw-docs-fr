...
Le streaming et la visibilité de la progression sont bien couverts dans la documentation et les tests : OpenClaw sépare le streaming du fournisseur/runtime de la livraison de canal, documente les modes de streaming de bloc et d'aperçu, et expose les mises à jour de progression d'outil et du cycle de vie des éléments avant la livraison finale. La couverture est Stable. La qualité est Beta car les différences de runtime et de canal produisent toujours des mises à jour de progression manquantes, des aperçus supprimés et une confusion occasionnelle de mise à jour terminale.

## Category Scope

Cette catégorie couvre le comportement de streaming et de progression visible par l'opérateur avant la livraison finale : les réponses en streaming, les modes de streaming d'aperçu et de bloc, et la visibilité de la progression via les mises à jour de progression d'outil ou du cycle de vie des éléments.

## Features

- Streaming replies: Mises à jour de bloc en streaming et sortie d'assistant partielle avant la livraison finale.
- Progress visibility: Événements d'aperçu de progression et mises à jour du cycle de vie des éléments exposées pendant l'exécution.
...
La couverture est forte dans la documentation de streaming, la documentation de boucle d'agent, le câblage d'événements, et les tests ciblés pour les mises à jour d'aperçu, les événements du cycle de vie des éléments, la suppression de progression en double, et le comportement de livraison terminal.

## Quality Score

- Score: `Beta (70%)`

Le comportement de streaming et de progression est globalement solide, mais les rapports de terrain montrent toujours des différences spécifiques au runtime et au canal autour des rappels de progression, des mises à jour terminales et du comportement d'aperçu.
...
- Certains comportements de visibilité de progression diffèrent encore selon le runtime et le canal.
- Les rappels de progression natifs peuvent toujours être supprimés ou retardés dans certains flux.
- Les mises à jour terminales après une activité d'outil longue durée ont toujours besoin d'un comportement plus cohérent visible par l'opérateur.
