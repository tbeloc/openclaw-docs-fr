...
<Tabs>
  ...
  <Tab title="Sessions et réponses déterministes">
    ...
    Si ce `chat_id` est explicitement configuré sous `channels.imessage.groups`, OpenClaw le traite comme du trafic de groupe (gating de groupe + isolement de session de groupe).
...
<AccordionGroup>
  <Accordion title="imsg non trouvé ou RPC non supporté">
