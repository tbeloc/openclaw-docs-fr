...
- [Discord](/channels/discord) — API Discord Bot + Gateway ; supporte les serveurs, les canaux et les DM.
...
- [IRC](/channels/irc) — Serveurs IRC classiques ; canaux + DM avec contrôles d'appairage/liste blanche.
...
- [Mattermost](/channels/mattermost) — API Bot + WebSocket ; canaux, groupes, DM (plugin, installé séparément).
...
- [Nostr](/channels/nostr) — DM décentralisés via NIP-04 (plugin, installé séparément).
