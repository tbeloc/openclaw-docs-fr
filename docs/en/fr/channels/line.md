---
summary: "Configuration du plugin LINE Messaging API, setup et utilisation"
read_when:
...
5. Définissez l'URL du webhook sur votre endpoint de passerelle (HTTPS requis) :
...
- `channels.line.allowFrom`: IDs utilisateur LINE en liste blanche pour les DMs
- `channels.line.groupPolicy`: `allowlist | open | disabled`
- `channels.line.groupAllowFrom`: IDs utilisateur LINE en liste blanche pour les groupes
...
- **Pas d'événements entrants :** confirmez que le chemin du webhook correspond à `channels.line.webhookPath` et que la passerelle est accessible depuis LINE.
