...
Les broadcast groups sont évalués après les listes blanches de canaux et les règles d'activation de groupe. Dans les groupes WhatsApp, cela signifie que les diffusions se produisent quand OpenClaw répondrait normalement (par exemple : sur mention, selon vos paramètres de groupe).
