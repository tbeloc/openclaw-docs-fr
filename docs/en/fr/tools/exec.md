...
- `yieldMs` (par défaut 10000) : passe automatiquement en arrière-plan après le délai
...
- Les vérifications préalables des scripts (pour les erreurs de syntaxe shell Python/Node courantes) n'inspectent que les fichiers à l'intérieur de la
...
Il met à jour **l'état de la session uniquement** et n'écrit pas la configuration. Pour désactiver complètement exec, refusez-le via la politique d'outil
