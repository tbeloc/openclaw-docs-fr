...
Lorsqu'une session est **sandboxée**, les processus de compétences s'exécutent à l'intérieur de Docker. Le sandbox
...
- intégrer l'env dans votre image sandbox personnalisée
