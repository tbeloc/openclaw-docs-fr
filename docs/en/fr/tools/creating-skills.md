...
read_when:
  ...
  - Vous avez besoin d'un flux de travail de démarrage rapide pour les compétences basées sur SKILL.md
---
...
Une compétence est un répertoire contenant un fichier `SKILL.md` (qui fournit des instructions et des définitions d'outils au LLM) et éventuellement des scripts ou des ressources.
...
Lorsque l'utilisateur demande un salut, utilisez l'outil `echo` pour dire « Hello from your custom skill! ».
```
