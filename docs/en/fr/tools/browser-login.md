...
OpenClaw contrôle un **profil Chrome dédié** (nommé `openclaw`, interface teintée d'orange). C'est un profil distinct de votre profil de navigateur quotidien.

Pour les appels d'outils de navigateur d'agent :
