...
Si votre Gateway s'exécute sur une autre machine, démarrez un hôte de nœud sur la machine qui exécute Chrome. La Gateway proxiera les actions du navigateur vers ce nœud ; l'extension + relais restent locaux à la machine du navigateur.
...
- Aperçu de l'outil Browser : [Browser](/fr/tools/browser)
