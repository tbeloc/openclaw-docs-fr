...
- **[fish-audio-speech](/plugins/reference/fish-audio-speech)** (`@openclaw/fish-audio-speech`) - npm. Fish Audio S2.1 hosted text-to-speech with streaming, voice notes, and telephony output.
