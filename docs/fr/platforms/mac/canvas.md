...
A2UI est hébergé par l'hôte canvas Gateway et rendu à l'intérieur du panneau Canvas. Lorsque la Gateway annonce un hôte Canvas, l'application macOS navigue automatiquement vers la page hôte A2UI à la première ouverture.
