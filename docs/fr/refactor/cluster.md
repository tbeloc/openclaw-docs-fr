...
read_when:
  - Vous voulez réduire le LOC total sans changer le comportement
  - Vous choisissez la prochaine passe de déduplication ou d'extraction
title: "Backlog de refactorisation de clusters"
---

# Backlog de refactorisation de clusters

Classé par réduction LOC probable, sécurité et portée.
...
De nombreux fichiers d'intégration se répètent :
...
## 6. Nettoyage de petits clones exacts
...
- rendu de diagnostics de port dupliqué :
...
2. Nettoyage de petits clones exacts
3. Extraction de constructeur de configuration et de sécurité
4. Extraction d'aide de test
5. Extraction d'étape d'intégration
6. Extraction d'aide de cycle de vie du moniteur
