...
- `detectors.pingPong`: détecte les motifs ping-pong alternés.

## Configuration recommandée

- Commencez avec `enabled: true`, valeurs par défaut inchangées.
- Maintenez les seuils ordonnés comme `warningThreshold < criticalThreshold < globalCircuitBreakerThreshold`.
