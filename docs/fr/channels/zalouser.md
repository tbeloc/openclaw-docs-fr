---
summary: "Support de compte personnel Zalo via zca-js natif (connexion QR), capacités et configuration"
read_when:
...
- Les commandes de contrôle autorisées (par exemple `/new`) peuvent contourner le contrôle de mention.
...
**Mise à niveau à partir d'une ancienne configuration basée sur CLI :**
