...
read_when: "Vous avez rencontré une 'prison sandbox' ou un refus d'outil/exécution élevé et vous voulez la clé de configuration exacte à modifier."
status: active
---
...
- Elevated n'est **pas** limité aux compétences et ne **remplace pas** l'autorisation/refus d'outil.
