...
| `hot`                 | Appliquer uniquement les changements sûrs pour le chaud                |
...
- Les clients du protocole Gateway échouent rapidement lorsque la Gateway est indisponible (pas de secours de canal direct implicite).
