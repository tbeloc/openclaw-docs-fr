...
Consultez le [README du plugin OAuth MiniMax](https://github.com/openclaw/openclaw/tree/main/extensions/minimax-portal-auth) pour plus de détails.
...
**Idéal pour :** conserver votre modèle de dernière génération le plus puissant comme principal, basculer vers MiniMax M2.5.
