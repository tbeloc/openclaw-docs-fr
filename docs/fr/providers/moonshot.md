...
Remarque : Moonshot et Kimi Coding sont des fournisseurs séparés. Les clés ne sont pas interchangeables, les points de terminaison diffèrent, et les références de modèle diffèrent (Moonshot utilise `moonshot/...`, Kimi Coding utilise `kimi-coding/...`).
...
- Utilisez `https://api.moonshot.ai/v1` pour le point de terminaison international, et `https://api.moonshot.cn/v1` pour le point de terminaison chinois.
