...
- Le fournisseur s'active automatiquement quand `NVIDIA_API_KEY` est défini ; utilise les paramètres par défaut statiques (fenêtre de contexte de 131 072 jetons, 4 096 jetons maximum).
