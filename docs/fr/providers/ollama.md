...
3. Ouvrir un flux de connexion navigateur si vous choisissez **Cloud + Local** et n'êtes pas connecté à ollama.com.
...
Pour utiliser les modèles cloud, sélectionnez le mode **Cloud + Local** lors de l'intégration. L'assistant vérifie si vous êtes connecté et ouvre un flux de connexion navigateur si nécessaire. Si l'authentification ne peut pas être vérifiée, l'assistant revient aux défauts de modèles locaux.
